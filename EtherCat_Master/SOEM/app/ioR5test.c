...
extern int dorun;
IOR5_PDO_Output *output_IOR5;
IOR5_PDO_Input *input_IOR5;
	...
	if (ec_init(ifname))
	{
		...
		if ( ec_config_init(FALSE) > 0 )
		{
			...
			if (ec_slave[0].state == EC_STATE_OPERATIONAL )
			{
				...
				output_IOR5 = (IOR5_PDO_Output *)ec_slave[1].outputs;
				input_IOR5  = (IOR5_PDO_Input *)ec_slave[1].inputs;
			}
			else
			{
		...
		else
		{
			...
			lcd_show_string(200, 130, 300, 16, 16, "ioR5test: No slaves found!\n", BLACK);
		}
	}
	else
	{
